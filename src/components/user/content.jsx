...
//styles 
const camera = require('./camera (1).png');
const fooddrink = require('./fooddrink.png');
const romance = require('./romance.png');
const health = require('./health.png');
const biography = require('./biography.png');
const avenir = require('./avenir.jpg');
const release = require('./release.png');
const author1 = require('./author-1.jpg');
const author2 = require('./author-2.jpg');
const author3 = require('./author-3.jpg');
const author4 = require('./author-4.jpg');
const author5 = require('./author-5.jpg');
function Content() {
    return (
